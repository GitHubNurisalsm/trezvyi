...
export function ContactActions({
  ...
  return (
    <div className="grid w-full gap-3 sm:grid-cols-2">
      ...
      <Link
        href="/zakaz-v-1-klik"
        className="tap-action inline-flex min-h-12 items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3 text-center text-sm font-bold text-slate-700 hover:bg-slate-50 sm:col-span-2"
      >
        Выбрать услугу
      </Link>
    </div>
